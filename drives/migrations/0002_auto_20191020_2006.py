...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='by',
            field=models.ManyToManyField(related_name='rider_by', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='riderreview',
            name='drive',
        ...
        migrations.AddField(
            model_name='riderreview',
            name='of',
            field=models.ManyToManyField(related_name='rider_of', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='location',
        ...
        migrations.AddField(
            ...
            name='by',
            field=models.ManyToManyField(related_name='driver_by', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='driverreview',
            name='drive',
        ...
        migrations.AddField(
            model_name='driverreview',
            name='of',
            field=models.ManyToManyField(related_name='driver_of', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='drive',
            name='driver',
